...
<body onload="onload_fun()">
                    ...
                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                        <div class="mdc-card">
                            <section class="mdc-card__primary">
                                <h1 class="mdc-card__title mdc-card__title--large">Selected customer And Place of supply
                                    :</h1>
                            </section>
                        </div>
                    </div>
				            				                    ...
				            				                    if (mysqli_num_rows($result) > 0)
				            		                                while($row = mysqli_fetch_assoc($result)){
				                                                        ...
				                                                        " <td style=\"text-align: left; vertical-align: inherit; font-size: 15px;\">$row[cust_id]</td>" .
																			...
																			" <td style=\"text-align: left; vertical-align: inherit; font-size: 15px;\">$row[address]</td>" .
    ...
    function select_cust(obj) {
        ...
        $.ajax({
            ...
            url: '../../DBOperation.php',
            data: {
                cust_id: parseInt(trObj.children[0].innerHTML),
                log12: 1
            },
            success: function(html) {
                if (html == 0) {
